...
<html lang="fr">
    ...
    <main class="profile-container">
        <!-- Menu latéral -->
        <aside class="sidebar">
            <a href="profil_user.html" class="menu-btn active">Profil</a>
        	<a href="profil_travel.html" class="menu-btn">Voyages prévus</a>
        ...
        <section class="profile-content">
            ...
            <div class="profile-info">
                ...
                <div class="info">
                    <p><strong>Nom :</strong> <span>Dupont</span> <button class="edit-btn">✏️</button></p>
                    <p><strong>Prénom :</strong> <span>Jean</span> <button class="edit-btn">✏️</button></p>
                    <p><strong>Email :</strong> <span>jean.dupont@email.com</span> <button class="edit-btn">✏️</button></p>
                </div>
            </div>
        </section>
    </main>
