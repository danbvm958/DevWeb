...
--
-- Hôte : sql112.infinityfree.com
-- Généré le :  mer. 21 mai 2025 à 08:03
...
--
-- Base de données :  `if0_38962226_ma_bdd`
--
...
(11, 3, 27, 69, 141, '95000.00'),
(12, 3, 27, 70, 143, '95000.00'),
(13, 3, 28, 72, 147, '95000.00'),
(14, 4, 27, 69, 141, '95000.00'),
(15, 4, 27, 70, 143, '95000.00'),
(16, 4, 28, 72, 147, '95000.00'),
(17, 5, 1, 1, 1, '67500.00'),
(18, 5, 1, 2, 3, '67500.00'),
(19, 5, 2, 4, 7, '67500.00'),
(20, 5, 2, 6, 11, '67500.00'),
(21, 5, 3, 8, 15, '67500.00');
...
INSERT INTO `utilisateur` (`NomUtilisateur`, `Email`, `MotDePasse`, `Nom`, `Prenom`, `Anniversaire`, `Types`, `Id`, `Token`, `TokenExpiration`) VALUES
('danbvm95', 'danbavamian747@gmail.com', '$2y$10$LFD6nRWSrYeNMirekMp67eDe5MVlU4IeSv5tvwaxZCMn0.fJwoEra', 'Bavamian', 'Dan', '2005-09-09', 'normal', 2, 'e8648c094747de074a800827e988d667', '2025-05-14 22:22:13'),
('hp', 'harry@gmail.com', '$2y$10$uIOAWm4aHPpSQB9pIX5DPevuQoLe89zcQaroPaI5sGRXvcz0svQ/O', 'potter', 'Harry', '1990-06-01', 'normal', 3, 'NULL', NULL),
('dan le gros caca', 'caca.pipi@vava.com', '$2y$10$ZqklDlfDwt3Jd5Gq2xRi1uQULVyBhQZU/LWeowrfdeT7vw1/F5hfG', 'caca', 'pipi', '1843-05-04', 'normal', 4, 'NULL', NULL),
('grossemerde', 'bassem8000@gmail.com', '$2y$10$tXfaIJxWiHgn5C3.XFI7xedzH/itOgXdUNmxdWpwLUTdVjLhQPdqC', 'bacha', 'bassem', '1754-08-17', 'normal', 5, 'NULL', NULL),
('zak', 'abdelmoula.zd@gmail.com', '$2y$10$/uVomXWRWcVi4UWC1l4ILO9.FcwCLZ4QdoWya.Rpp5W0hN3srRYJ6', 'abdelmoula', 'zied', '2005-08-12', 'normal', 6, '791cbfd97ac1e0b26338adcaae86f7ea', '2025-05-14 16:34:09'),
('kylian', 'kykydebondy@gmail.com', '$2y$10$/SHgtY2Ouv9AZaZ9d5mozOm0wIAI0bw7dRLH1ueSMWDpcXqNKk8pG', 'kylian', 'mbappe', '2005-04-15', 'normal', 7, NULL, NULL),
('haya', 'acac@gmail.com', '$2y$10$QwU9RVN8l04N/Zdmq8mN.ulxzU25LYpZRPaqqud98EKgkM.HWcxxu', 'Abdelmoula', 'zied', '2005-08-12', 'normal', 8, NULL, NULL);
...
INSERT INTO `voyages` (`IdVoyage`, `Titre`, `Description`, `DateDebut`, `DateFin`, `PrixBase`, `PlacesDispo`, `Pays`) VALUES
(1, 'Nuit de terreur au château de Bran', 'Plongez dans l\'atmosphère envoûtante du château de Dracula pour une nuit d\'épouvante inoubliable.', '2025-10-30', '2025-11-01', '50000.00', 9, 'Roumanie'),
(2, 'Week-end dans la maison hantée de Pripyat', 'Explorez les vestiges de la ville fantôme de Pripyat, avec une nuit dans une maison réputée hantée près de la zone d\'exclusion de Tchernobyl.', '2025-11-15', '2025-11-17', '65000.00', 8, 'Ukraine'),
(3, 'Nuit de terreur au château de Bran', 'Plongez dans l\'atmosphère envoûtante du château de Dracula pour une nuit d\'épouvante inoubliable.', '2025-10-30', '2025-11-01', '50000.00', 5, 'Roumanie'),
(4, 'Week-end dans la maison hantée de Pripyat', 'Explorez les vestiges de la ville fantôme de Pripyat, avec une nuit dans une maison réputée hantée près de la zone d\'exclusion de Tchernobyl.', '2025-11-15', '2025-11-17', '65000.00', 5, 'Ukraine'),
(5, 'Expédition dans la forêt des suicidés', 'Osez pénétrer dans la mystérieuse forêt d\'Aokigahara au Japon, lieu empreint de légendes terrifiantes et d\'énergie mystique.', '2026-01-10', '2026-01-15', '85000.00', 5, 'Japon'),
(6, 'Expédition dans la forêt des suicidés', 'Osez pénétrer dans la mystérieuse forêt d\'Aokigahara au Japon, lieu empreint de légendes terrifiantes et d\'énergie mystique.', '2026-01-10', '2026-01-15', '85000.00', 6, 'Japon'),
(7, 'Expédition dans la forêt des suicidés', 'Osez pénétrer dans la mystérieuse forêt d\'Aokigahara au Japon, lieu empreint de légendes terrifiantes et d\'énergie mystique.', '2026-01-10', '2026-01-15', '85000.00', 8, 'Japon'),
(8, '72h dans l\'asile hanté de Willowbrook', 'Plongez dans l\'horreur absolue de cet ancien asile où des expériences médicales terrifiantes furent menées. Âmes sensibles s\'abstenir.', '2025-09-20', '2025-09-23', '78000.00', 6, 'États-Unis'),
(9, 'Croisière fantôme sur le Queen Mary', 'Embarquez pour une traversée cauchemardesque sur ce paquebot hanté, théâtre de nombreux décès tragiques et phénomènes paranormaux.', '2026-02-13', '2026-02-16', '88000.00', 4, 'États-Unis'),
(10, 'Exploration de l\'Hôpital Abandonné de Beelitz', 'Plongez dans l\'atmosphère angoissante de l\'hôpital militaire abandonné de Beelitz-Heilstätten en Allemagne, un lieu chargé d\'histoires et de phénomènes étranges.', '2026-03-15', '2026-03-20', '78000.00', 5, 'Allemagne'),
(11, 'Nuit d\'épouvante sur l\'île de Poveglia', 'Vivez une expérience terrifiante sur l\'île maudite de Poveglia en Italie, autrefois utilisée comme asile et lieu de quarantaine.', '2026-04-10', '2026-04-15', '82000.00', 5, 'Italie'),
(12, 'Immersion nocturne au Sanatorium de Waverly Hills', 'Explorez l\'un des lieux les plus hantés des États-Unis, l\'ancien sanatorium de Waverly Hills, où les esprits des patients défunts errent encore.', '2026-05-20', '2026-05-25', '86000.00', 6, 'États-Unis'),
(13, 'Plongée dans la cité souterraine d\'Édimbourg', 'Découvrez l’effrayante ville cachée sous Édimbourg, un réseau de tunnels et de ruelles où le temps semble s’être arrêté depuis le XVIIe siècle.', '2026-06-12', '2026-06-17', '75000.00', 5, 'Royaume-Uni'),
(14, 'Séjour paranormal dans la maison d\'Amityville', 'Osez passer plusieurs nuits dans l’une des maisons hantées les plus célèbres au monde, connue pour ses phénomènes paranormaux inexpliqués.', '2026-09-10', '2026-09-15', '89000.00', 6, 'États-Unis'),
(15, 'Descente dans les profondeurs des catacombes de Paris', 'Découvrez un Paris inconnu en explorant ses catacombes, un immense ossuaire souterrain où règne une atmosphère lugubre.', '2026-10-05', '2026-10-10', '76000.00', 4, 'France'),
(16, 'Nuit terrifiante à l\'asile de Pennhurst', 'Plongez dans l’histoire troublante de cet ancien asile psychiatrique abandonné, connu pour ses phénomènes paranormaux.', '2026-11-15', '2026-11-20', '92000.00', 37, 'États-Unis'),
(17, 'Survivre une nuit dans Pripyat, ville fantôme', 'Découvrez l’atmosphère post-apocalyptique de Pripyat, ville abandonnée après la catastrophe de Tchernobyl.', '2026-12-05', '2026-12-10', '99000.00', 12, 'Ukraine');
...
(3, 10, 2, '2025-05-12', '95000.00', 1, 0),
(4, 10, 2, '2025-05-12', '95000.00', 1, 0),
(5, 1, 2, '2025-05-12', '67500.00', 1, 0);
...
--
ALTER TABLE `options_commande`
  MODIFY `IdOptionCommande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
